...
class MockConfig:
    ...
    TASK_INTERVAL_ENVIRONMENT = 1.0
    TASK_INTERVAL_PUMP = 2.0
    TASK_INTERVAL_ALERT = 3.0
    TASK_INTERVAL_MQTT = 5.0
    TASK_INTERVAL_AI = 10.0
    TASK_INTERVAL_PERSISTENCE = 60.0
...
def test_full_system_integration(greenhouse, scheduler, mock_config):
    ...
    # Chạy scheduler đồng bộ giới hạn trong 5 tick
    scheduler.run(tick_interval=0.1, max_ticks=5)
